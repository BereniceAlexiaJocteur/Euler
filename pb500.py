...
def main():
    ...
    # not really accurate
    sieve = primes.sieve8(upper_bound_prime(500500))
    ...
    # But when for a element of sieve this item is greater than the last element of the sieve I will do the same with the
    # formula "element of sieve"^4 until I reach the same limit then with "element"^8 and so on
